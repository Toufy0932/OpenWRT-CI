...
#AIROHA（XG-040G-MD）平台调整：lan4 作 WAN + 修 dtsi interrupts
if [[ "${WRT_TARGET^^}" == *"AIROHA"* ]]; then
	sed -i 's/ucidef_set_interface_lan "lan1 lan2 lan3 lan4"/ucidef_set_interfaces_lan_wan "lan1 lan2 lan3" "lan4"/g' \
